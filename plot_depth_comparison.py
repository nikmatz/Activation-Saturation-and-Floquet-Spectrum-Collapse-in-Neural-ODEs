...
License: MIT
Shows how the bound C_W · δ^q tightens exponentially with the number
of saturated layers q. Uses the same data (δ(s), C_W(s))
from Illustration A (32-unit MLP, q=1), and computes what would
happen if we had q=2 or q=3 saturated layers.
"""
